...
module.exports = {
    ...
    onStart: async function ({ api, message, args, event }) {
        ...
        const githubToken = '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'; //add your GitHub token 
        const owner = 'xnil-6x'; //add your GitHub username 
        const repo = 'V60';  //add your repo name
        const branch = 'main';
